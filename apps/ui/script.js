...
const TYPE_ICON_MAP = {
  general_waste: { labelKey: "type.general_waste", icon: "🗑️", cssClass: "type-general_waste" },
  packaging: { labelKey: "type.packaging", icon: "🧃", cssClass: "type-packaging" },
  glass: { labelKey: "type.glass", icon: "🍾", cssClass: "type-glass" },
  paper: { labelKey: "type.paper", icon: "📰", cssClass: "type-paper" },
  textile: { labelKey: "type.textile", icon: "👕", cssClass: "type-textile" },
  electronics: { labelKey: "type.electronics", icon: "💻", cssClass: "type-electronics" },
  cardboard: { labelKey: "type.cardboard", icon: "📦", cssClass: "type-cardboard" },
  bulky_waste: { labelKey: "type.bulky_waste", icon: "🛋️", cssClass: "type-bulky_waste" },
  bottle_recycling_machine: { labelKey: "type.bottle_recycling_machine", icon: "🔄", cssClass: "type-bottle_recycling_machine" },
  yard_waste: { labelKey: "type.yard_waste", icon: "🌿", cssClass: "type-yard_waste" },
...
const TRANSLATIONS = {
  en: {
    ...
    "type.general_waste": "Green Bin",
    "type.packaging": "Orange Packaging Bin",
    "type.glass": "Purple Glass Bin",
    "type.paper": "Blue Paper Bin",
    "type.textile": "Textile Bin",
    "type.electronics": "Electronics / E-Waste Bin",
    "type.cardboard": "Cardboard Cage / Bin",
    "type.bulky_waste": "Bulky Waste Container",
    "type.bottle_recycling_machine": "Bottle Recycling Machine",
    "type.yard_waste": "Yard Waste / Pruning",
  ...
  he: {
    ...
    "type.general_waste": "פח ירוק (כללי)",
    "type.packaging": "אריזות (כתום)",
    "type.glass": "זכוכית (סגול)",
    "type.paper": "נייר (כחול)",
    "type.textile": "טקסטיל",
    "type.electronics": "אלקטרוניקה",
    "type.cardboard": "קרטונייה",
    "type.bulky_waste": "מכולה לפסולת גושית",
    "type.bottle_recycling_machine": "מכונה למיחזור בקבוקים",
    "type.yard_waste": "גזם",
